    ...
    <AnimatePresence>
      ...
      <div className="flex flex-col col-span-5 justify-center items-start ml-12 lg:ml-64 mt-16 lg:mt-0">
        ...
        <motion.p 
          ...
          animate="animate"
          variants={slideRight} 
          className="text-xl lg:text-2xl lg:-mt-3 ml-8 lg:ml-52 font-bold text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">Full-Stack Software Engineer</motion.p>
      </div>
      <Socials />
